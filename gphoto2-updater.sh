...
apt-get install -y build-essential libltdl-dev libusb-dev libexif-dev udev libpopt-dev libudev-dev pkg-config git automake autoconf autopoint gettext libtool wget
